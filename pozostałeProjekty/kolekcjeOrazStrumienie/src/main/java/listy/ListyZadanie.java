package listy;
/**
 * operacje na listach (po każdym punkcie wyświetlamy)
 wypełniamy listę kolejnymi wartościami od 1 do 10
 co trzecią liczbę zwiększamy o wartość jej poprzednika
 każdą liczbę parzystą dzielimy przez 2
 sumujemy wszystkie liczby z listy
 Znajdujemy największy i najmniejszy element listy
